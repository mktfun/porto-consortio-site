...
import { ShieldAlert, TerminalSquare, BoxSelect, ArrowRight } from "lucide-react";
...
export function Features() {
  ...
  return (
    <section id="coberturas" ref={container} className="py-32 bg-background relative z-10">
      <div className="max-w-7xl mx-auto px-6 lg:px-16">
        ...
        <div className="mb-20">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-white mb-6">
            Artefatos Funcionais de <br className="hidden md:block"/> Proteção Direta.
          </h2>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          {/* Card 1: RCTR-C */}
          <div className="feature-card group relative bg-card rounded-[2rem] p-10 border border-white/5 hover:border-accent/30 hover:-translate-y-2 transition-all duration-500 overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col h-full">
              ...
              <div className="space-y-3 mb-8">
                <div className="flex items-center gap-3 text-sm font-mono text-slate-500">
                  <div className="w-1.5 h-1.5 rounded-full bg-accent"></div> Colisão Frontal/Lateral
                </div>
                <div className="flex items-center gap-3 text-sm font-mono text-slate-500">
                  <div className="w-1.5 h-1.5 rounded-full bg-accent"></div> Capotamento
                </div>
                <div className="flex items-center gap-3 text-sm font-mono text-slate-500">
                  <div className="w-1.5 h-1.5 rounded-full bg-accent"></div> Incêndio/Explosão
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Card 2: RC-DC */}
          <div className="feature-card group relative bg-primary rounded-[2rem] p-10 border border-primary-foreground/10 hover:-translate-y-2 transition-all duration-500 overflow-hidden shadow-2xl shadow-primary/20">
            ...
            <div className="relative z-10 flex flex-col h-full">
              ...
              <div className="bg-black/20 rounded-xl p-4 backdrop-blur-sm border border-white/10 mb-8 font-mono text-xs text-green-400 leading-tight">
          ...
          <div className="feature-card group relative bg-card rounded-[2rem] p-10 border border-white/5 hover:border-accent/30 hover:-translate-y-2 transition-all duration-500 overflow-hidden">
            <div className="relative z-10 flex flex-col h-full">
              ...
              {/* Fake Micro UI / Interactive element */}
              <div className="bg-background rounded-xl p-4 border border-white/5 mb-8">
                ...
                <div className="w-full bg-white/5 rounded-full h-1.5 mb-4 overflow-hidden">
                  <div className="bg-accent h-1.5 w-[80%] rounded-full"></div>
                </div>
                <div className="flex justify-between text-xs font-mono text-slate-500 mb-2">
                ...
                <div className="w-full bg-white/5 rounded-full h-1.5 overflow-hidden">
                  <div className="bg-blue-500 h-1.5 w-[65%] rounded-full"></div>
                </div>
              </div>
