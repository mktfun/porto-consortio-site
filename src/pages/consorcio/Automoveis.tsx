      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden bg-slate-900">
        <div className="absolute inset-0 z-0">
          <img 
            ...
            alt="Carro de luxo - Consórcio de Automóveis" 
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-16">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mb-4">Acelerando os Seus Sonhos</h2>
            <p className="text-slate-500 max-w-2xl mx-auto">Vantagens exclusivas do Consórcio Auto Porto Seguro, mediadas por uma corretora com mais de 10 anos de mercado.</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100">
              ...
              <h3 className="text-xl font-bold mb-3 text-slate-800">Poder de Compra à Vista</h3>
              <p className="text-slate-500">Ao ser contemplado, você tem a carta de crédito na mão, garantindo ótimos descontos na negociação do veículo.</p>
            </div>
            <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100">
              ...
              <h3 className="text-xl font-bold mb-3 text-slate-800">Sem Juros</h3>
              <p className="text-slate-500">A taxa de administração é diluída ao longo dos meses e sai infinitamente mais barata que os juros bancários.</p>
            </div>
            <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100">
              ...
              <h3 className="text-xl font-bold mb-3 text-slate-800">Flexibilidade Total</h3>
              <p className="text-slate-500">Você escolhe a marca, modelo e ano do carro que desejar. Novo, seminovo ou usado, a escolha é sua.</p>
            </div>
          </div>
        </div>
      </section>
