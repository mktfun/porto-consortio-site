      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden bg-slate-900">
        <div className="absolute inset-0 z-0">
          <img 
            ...
            alt="Gráficos Financeiros - Investimentos" 
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-16 relative z-10 text-center">
          ...
          <p className="text-xl text-slate-300 max-w-2xl mx-auto mb-10">
            A forma inteligente de construir patrimônio sólido ou rentabilizar capital através da compra planejada.
          </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-16">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mb-4">Construa sua Riqueza</h2>
            <p className="text-slate-500 max-w-2xl mx-auto">Em vez de guardar dinheiro na poupança, invista em cartas de crédito contempladas e alavancagem de imóveis.</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100">
              ...
              <h3 className="text-xl font-bold mb-3 text-slate-800">Poupança Forçada</h3>
              <p className="text-slate-500">O consórcio atua como uma ferramenta disciplinar de investimento para quem tem dificuldade de poupar mensalmente.</p>
            </div>
            <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100">
              ...
              <h3 className="text-xl font-bold mb-3 text-slate-800">Alavancagem de Renda</h3>
              <p className="text-slate-500">Ao ser contemplado, você pode adquirir imóveis para alugar, onde o próprio aluguel paga o restante das parcelas.</p>
            </div>
            <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100">
              ...
              <h3 className="text-xl font-bold mb-3 text-slate-800">Atualização Monetária</h3>
              <p className="text-slate-500">O valor da sua carta de crédito é corrigido anualmente, garantindo que você não perca seu poder de compra.</p>
            </div>
          </div>
        </div>
      </section>
